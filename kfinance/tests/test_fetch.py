...
class TestMarketCap:
    ...
    @pytest.mark.parametrize("start_date, start_date_url", [
        (None, "none"), ("2025-01-01", "2025-01-01")
    ])
    @pytest.mark.parametrize("end_date, end_date_url", [
        (None, "none"), ("2025-01-01", "2025-01-01")
    ])
    def test_fetch_market_cap(self, start_date: str | None, start_date_url: str,
                              end_date: str | None, end_date_url: str) -> None:
        company_id=12345
