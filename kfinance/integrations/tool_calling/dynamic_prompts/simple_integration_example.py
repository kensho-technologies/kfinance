...
def execute_kfinance_tool(tool_name: str, parameters: Dict) -> Dict:
...
if __name__ == "__main__":
    ...
    print("Tool calls:", len(result['llm_response'].get('tool_calls', [])))
    print("Results:", len(result['tool_results']))
    print("Success! ✅")
