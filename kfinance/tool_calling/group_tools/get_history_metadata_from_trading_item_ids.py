...
from kfinance.kfinance import TradingItems, TradingItem
...
class GetHistoryMetadataFromTradingItemIds(KfinanceTool):
    ...
    def _run(self, trading_item_ids: list[int]) -> dict[str, str|dict]:
        ...
        fetched_results: dict[TradingItem, dict | None] = trading_items.history_metadata
        ...
        for trading_item, result in fetched_results.items():
            ...
            stringified_results[f"trading_item_id: {trading_item.trading_item_id}"] = stringified_result
