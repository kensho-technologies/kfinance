...
class GetFinancialLineItemFromIdentifiers(KfinanceTool):
    ...
    description: str = dedent("""
        ...
        - For the following Enterprise Value (EV) ratio line items, always specify period_type as either "quarterly" or "ltm" (Last Twelve Months) - do not rely on the default annual period. Prefer "ltm" as the period_type for these line items:
